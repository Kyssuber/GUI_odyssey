...
class MainPage(tk.Frame):    
    ...
    def __init__(self, parent, controller):
        ...
        self.keyvar.set(self.keyvar_options[0])
    ...
    def populate_soni_widget(self):
        ...
        key_lab = tk.Label(self.frame_soni,text='Key Sig').grid(row=5,column=0)
...
##########
    ...
    def midi_setup_bar(self):
        ...
        self.note_names = 'D2-E2-F#2-G2-A2-B2-C#2-D3-E3-F#3-G3-A3-B3-C#3-D4-E4-F#4-G4-A4-B4-C#4-D5-E5-F#5-G5-A5-B5-C#5'   #D-major
